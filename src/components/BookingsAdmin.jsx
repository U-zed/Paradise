  ...
  return (
    <main className="relative  pt-12 ">
      ...
      <div className="overflow-auto [&::-webkit-scrollbar]:hidden scrollbar-none h-screen ">
        ...
        <p className="text-sm text-center text-black pb-6 max-w-2xl mx-auto">
          Manage customer appointments, review booking details and keep track of upcoming, current and completed salon visits.
        </p>
